...
MRIO_Z = np.zeros((7987,7987))
for m in range(0,7987):
    MRIO_Z[:,m] = MRIO_A[:,m] * MRIO_X[m]

Filestring_Matlab_out = 'C:\\Users\\ghardadi\\EXIOBASE_3\\IOT_2011_ixi' + '\\satellite\\' + 'ZMatrix_Mon_49R_2018_06_01_ITC.mat'
scipy.io.savemat(Filestring_Matlab_out, mdict={'EB3_Z_ITC':MRIO_Z,
                                               'EB3_TableUnits':'MEUR',
