...
# Script EB3Parse_3.4_REFERENCE.py
...
if Name_Script != 'EB3Parse_3.4_REFERENCE': # Name of this script must equal the specified name in the Excel config file
...
if ScriptConfig['ModelType'] == 'ixi':        
    ...
    Filestring_Matlab_out = MRIO_Paths.IOModelPath + 'EXIOBASE3.4_' + str(ScriptConfig['CurrentYear']) + '_ITC.mat'
    scipy.io.savemat(Filestring_Matlab_out, mdict={'ScriptConfig':ScriptConfig,
                                                        ...
                                                        'EB3_Y':MRIO_Y,
                                                        #'EB3_A_ITC':MRIO_A,
                                                        'EB3_ProductNames163':DES_ProductNames163,
